...
use Pronos\PronosticsBundle\Form\ChampionshipType;
...
class ChampionshipController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PronosPronosticsBundle:Championship')->findAll();

        return $this->render('PronosPronosticsBundle:Championship:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PronosPronosticsBundle:Championship:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Championship $entity)
    {
        $form = $this->createForm(new ChampionshipType(), $entity, array(
            'action' => $this->generateUrl('championship_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PronosPronosticsBundle:Championship')->find($id);
        ...
        return $this->render('PronosPronosticsBundle:Championship:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PronosPronosticsBundle:Championship:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new ChampionshipType(), $entity, array(
            'action' => $this->generateUrl('championship_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('championship_delete', array('id' => $id)))
            ->setMethod('DELETE')
