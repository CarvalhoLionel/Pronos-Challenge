...
use Pronos\PronosticsBundle\Entity\Organization;
use Pronos\PronosticsBundle\Form\OrganizationType;
...
class OrganizationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PronosPronosticsBundle:Organization')->findAll();

        return $this->render('PronosPronosticsBundle:Organization:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PronosPronosticsBundle:Organization:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PronosPronosticsBundle:Organization')->find($id);
        ...
        return $this->render('PronosPronosticsBundle:Organization:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PronosPronosticsBundle:Organization:edit.html.twig', array(
            'entity'      => $entity,
