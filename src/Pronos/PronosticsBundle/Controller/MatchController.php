...
use Pronos\PronosticsBundle\Entity\Match;
use Pronos\PronosticsBundle\Form\MatchType;
...
class MatchController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PronosPronosticsBundle:Match')->findAll();

        return $this->render('PronosPronosticsBundle:Match:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PronosPronosticsBundle:Match:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PronosPronosticsBundle:Match')->find($id);
        ...
        return $this->render('PronosPronosticsBundle:Match:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PronosPronosticsBundle:Match:edit.html.twig', array(
            'entity'      => $entity,
